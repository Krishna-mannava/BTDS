...
def getPrediction(filename):
    ...
    for i in predictions:
        if i<0.5 and i>=0:
           return 'Hurray!!!  No need to worry!',TRAIN_DIR,'You are not having any brain tumor. '+str((1-i)*100)
        if(i<=1 and i>=0.5):
           return 'Oops !!!  I’m very sorry!!!',TRAIN_DIR,'you are affected with brain tumor. '+str(i*100)